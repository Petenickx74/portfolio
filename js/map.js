jQuery(function($){
	...
	function randing_map(canvas, lan, lat){			
			...
			var infowindow = new google.maps.InfoWindow({
				content:"<div class='map_tel'><div class='map_tel'><span class='tel'>Email : </span>peternickell@gmail.com</div> <div class='map_tel'><span class='tel'>Phone : </span>(207) 423-4249</div></div>"
			});	
